...
<script>
	function validate() {
		...
		if (providerName != "" && address != "" && email != "" && phone != "") {
			...
			if (phone == "") {
				swal("Bạn phải nhập số điện thoại của nhà sản xuất.");
						...
						<div class="col-xs-12">
							<div class="x_panel">
								<div class="x_title">
									...
									<f:form class="form-horizontal form-label-left" action="updateProvider" modelAttribute="provider"
										onsubmit="return validate()">
										<div class="form-group message">${message}</div>
										<div class="form-group">
											<label class="control-label col-md-3 col-sm-3 col-xs-12"
												for="first-name">Mã nhà sản xuất <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 col-xs-12">
												<f:input type="text" id="providerId" class="form-control col-md-7 col-xs-12" path="providerId"
													readonly="true" />
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-3 col-sm-3 col-xs-12"
												for="first-name">Tên nhà sản xuất<span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 col-xs-12">
										...
										<div class="form-group">
											<label class="control-label col-md-3 col-sm-3 col-xs-12"
												for="last-name">Nơi ở <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 col-xs-12">
										...
										<div class="form-group">
											...
											<div class="col-md-6 col-sm-6 col-xs-12">
												<f:select id="status" class="form-control col-md-7 col-xs-12" path="status">
													<f:option value="True" label="Hợp tác" />
													<f:option value="False" label="Không còn hợp tác" />
												</f:select>
											</div>
										</div>
