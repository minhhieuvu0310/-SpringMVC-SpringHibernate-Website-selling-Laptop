						...
						<div class="col-xs-12">
							<div class="table-header">
								...
								Danh sách danh mục <br /> <a
									href="<%=request.getContextPath()%>/initInsertCatalog" class="">Thêm
									mới</a>
							</div>
							...
							<div>
								<table id="catalog" class="table table-striped table-bordered"
									...
									<tbody>
										<c:forEach items="${listCatalog}" var="items">
											<tr>
												<td>${items.catalogId }</td>
												<td>${items.catalogName }</td>
												<td class="hidden-480">${items.descriptions }</td>
												...
												<td>
													<div class="hidden-sm hidden-xs action-buttons">
														<a class="blue" href="viewCatalog?Id=${items.catalogId }"> <i
															class="ace-icon fa fa-search-plus bigger-130"></i>
														</a> <a class="green" href="initUpdateCatalog?Id=${items.catalogId }"> <i
															class="ace-icon fa fa-pencil bigger-130"></i>
														</a> <a class="red" href="deleteCatalog?Id=${items.catalogId }" onclick="return confirm('bạn có chắc muốn xóa không?')"> <i
