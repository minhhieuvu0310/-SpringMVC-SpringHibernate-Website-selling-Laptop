      ...
      <div class="main-content-inner">
        ...
        <div class="page-content">
            ...
            <div class="col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  ...
                  <f:form class="form-horizontal form-label-left" action="insertProduct" modelAttribute="newproduct" enctype="multipart/form-data" method="post">
          ...
          <div class="form-group">
            ...
            <div class="col-md-10 col-sm-10 col-xs-12">
              <input type="file" accept=".jpg,.jpeg,.png" multiple="multiple" name="imageLink" class="form-control col-md-7 col-xs-12" />
              <input type="file" accept=".jpg,.jpeg,.png" multiple="multiple" name="imageLink" class="form-control col-md-7 col-xs-12" />
              <input type="file" accept=".jpg,.jpeg,.png" multiple="multiple" name="imageLink" class="form-control col-md-7 col-xs-12" />
              <input type="file" accept=".jpg,.jpeg,.png" multiple="multiple" name="imageLink" class="form-control col-md-7 col-xs-12" />
              <input type="file" accept=".jpg,.jpeg,.png" multiple="multiple" name="imageLink" class="form-control col-md-7 col-xs-12" />
