	...
	type="text/javascript"></script>
        <script>
            function validate() {
                ...
                if (userName != "" && fullName != "" && pass != "" && address != "" && email != "" && sdt != "" && pattern.test(email) == true) {
                    return true;
                } else {
                    if (userName == "") {
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="x_panel">
                                        ...
                                        <f:form class="form-horizontal form-label-left" action="updateUser" modelAttribute="usersDetail" onsubmit="return validate()">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <f:input type="text" id="fullName" class="form-control col-md-7 col-xs-12" path="fullName" />
                                                </div>
                                            </div>
                                             <div class="form-group">
