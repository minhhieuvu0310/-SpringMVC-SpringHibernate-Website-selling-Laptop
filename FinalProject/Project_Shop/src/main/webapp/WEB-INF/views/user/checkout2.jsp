                                ...
                                <ul class="paymentmethod-list">
                                    <li class="paymentmethod-item" id="1">
                                        <label class="paymentmethod__label">
                                            <img class="paymentmethod__img" src="<c:url value="resources"/>/user/image/pay/1.PNG"></img>
                                        </label>
                                        <p class="paymentmethod__content">Thẻ nạp</p>
                                    </li>
                                    <li class="paymentmethod-item" id="2">
                                        <label class="paymentmethod__label">
                                            <img class="paymentmethod__img" src="<c:url value="resources"/>/user/image/pay/payment1.png"></img>
                                        </label>
                                        <p class="paymentmethod__content">Thẻ Tín Dụng</p>
                                    </li>
                                    <li class="paymentmethod-item" id="3">
                                        <label class="paymentmethod__label">
                                            <img class="paymentmethod__img" src="<c:url value="resources"/>/user/image/pay/pic4.png"></img>
                                        </label>
                            	...
                            	<c:forEach items="${sessionScope.listCart}" var="cart">
	                            	<li class="listCart__item">
	                                    <div class="listCart__item-left">
	                                        <img src="<c:url value="resources"/>/user/image/buy/${cart.getProduct().getImages() }" alt="NoImage" class="listCart__item-img">
