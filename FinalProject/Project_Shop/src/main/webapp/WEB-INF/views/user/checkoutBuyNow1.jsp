...
<link href="<c:url value=" resources/user/css/Header/Header.css" />"
	rel="stylesheet">
<link
	href="<c:url value=" resources/user/css/CheckOut1/checkout1.css" />"
	rel="stylesheet">
<!-- Footer -->
			...
			<div class="grid wide">
				<div class="row sm-gutter ">
					<div class="col l-7 m-12 c-12 customer-info">
						<form action="prePaymentBuyNow" method="post"
							class="customer-info__form" id="jsCustomer-form">
								...
								<div class="purchase-info__input-container">
									<div class="purchase-info__input-item">
										<div class="purchase-info__group purchase-info__group-w45">
											...
											<input required class="purchase-info__input"
												placeholder="Họ Và Tên" value="${users.getFullName() }"></input>
										</div>
										<div style="width: 16px;"></div>
										<div class="purchase-info__group purchase-info__group-w45">
											<div class="purchase-info__lable">Số Điện Thoại</div>
											<input required class="purchase-info__input"
												placeholder="Số Điện Thoại" value="${users.getPhone()}"></input>
										</div>
									</div>
									<div class="purchase-info__input-item">
										<div class="purchase-info__group">
											...
											<input required class="purchase-info__input"
												placeholder="Email" value="${users.getEmail() }"></input>
										</div>
									</div>
									<div class="purchase-info__input-item">
										<div class="purchase-info__group">
											<div class="purchase-info__lable">Tỉnh/ Thành phố,
												Quận/Huyện, Phường/Xã</div>
											<input class="purchase-info__input"
							...
							<div class="purchase-info__form">
								...
								<div class="purchase-info__input-container">
									<div class="purchase-info__input-item">
										<div class="purchase-info__group purchase-info__group-w45">
											<div class="purchase-info__lable">Họ Và Tên</div>
											<input name="name" class="purchase-info__input"
												placeholder="Họ Và Tên"></input>
										</div>
										<div style="width: 16px;"></div>
										<div class="purchase-info__group purchase-info__group-w45">
											<div class="purchase-info__lable">Số Điện Thoại</div>
											<input name="phone" class="purchase-info__input"
									...
									<div class="purchase-info__input-item">
										<div class="purchase-info__group">
											<div class="purchase-info__lable">Email</div>
											<input name="email" class="purchase-info__input"
								...
								<li class="listCart__item">
									...
									<div class="listCart__item-right">
										<span class="listCart__item-price"> 
											<fmt:formatNumber type="currency" currencySymbol="đ" value="${product.getProductHasDiscount() }">
											</fmt:formatNumber>
										</span>
									</div>
								</li>
