...
<body>
			...
			<div class="grid wide">
				<div class="row sm-gutter product-detail__info">
					...
					<div class="col l-7 m-12 c-12">
						<form method="post" id="frmProductdetails">
								...
								<div class="product-detail__Configuration">
									<div style="padding: 0 20px;">
										...
										<div class="product-detail__btn">
											...
											<div class="btn btn--primary product-detail__btn-buy" id="btnBuyNow">Mua Ngay</div>
										</div>
									</div>
								</div>
								<div
	...
	<script src="<c:url value="resources/user/js/producDetails1.js" />"></script>
</body>
</html>