...
<link
	...
	rel="stylesheet">
<link href="<c:url value=" resources/user/css/grid.css" />"
	rel="stylesheet">
<link href="<c:url value=" resources/user/css/base.css" />"
	rel="stylesheet">
<!-- Header -->
<link href="<c:url value=" resources/user/css/Header/Header.css" />"
	rel="stylesheet">
<link
	href="<c:url value=" resources/user/css/CheckOut2/checkout2.css" />"
	rel="stylesheet">
<!-- Footer -->
				...
				<div class="row sm-gutter ">
					<div class="col l-7 m-12 c-12 paymentmethod">
						<form action="paymentBuyNow" method="post"
							class="paymentmethod__form" id="jspaymentmethod-form">
							<input type="hidden" name="paymentmethod"
								value="Thanh Toán khi nhận hàng"> <input type="hidden"
								name="orderId" value="${Id }">
							<div class="paymentmethod-info">
								<h2 class="paymentmethod__title">Lựa chọn phương thức thanh
									toán</h2>
								<ul class="paymentmethod-list">
									<li class="paymentmethod-item" id="1"><label
										class="paymentmethod__label"> <img
											class="paymentmethod__img"
											src="<c:url value="resources"/>/user/image/pay/1.PNG"></img>
									</label>
										<p class="paymentmethod__content">Thẻ nạp</p></li>
									<li class="paymentmethod-item" id="2"><label
										class="paymentmethod__label"> <img
											class="paymentmethod__img"
											src="<c:url value="resources"/>/user/image/pay/payment1.png"></img>
									</label>
										<p class="paymentmethod__content">Thẻ Tín Dụng</p></li>
									<li class="paymentmethod-item" id="3"><label
										class="paymentmethod__label"> <img
											class="paymentmethod__img"
											src="<c:url value="resources"/>/user/image/pay/pic4.png"></img>
									</label>
							...
							<div class="paymentmethod__btn">
								<div
									class="paymentmethod__notice paymentmethod__notice--requirement"
									id="jspaymentmethod__notice--requirement">
									<p class="paymentmethod__content">Vui lòng chọn chức năng
										thanh toán</p>
								</div>
								<div
									class="paymentmethod__notice paymentmethod__notice--unactive">
									<p class="paymentmethod__content">Xin lỗi chức năng thanh
										toán này chưa được hệ thống hỗ trợ</p>
								</div>
								<div class="paymentmethod__notice"
									id="jspaymentmethod__selected">
									<p class="paymentmethod__content"
										id="jspaymentmethod__selected-text"></p>
								</div>
						...
						<div class="listCart">
							...
							<ul class="listCart__list">
								<li class="listCart__item">
									<div class="listCart__item-left">
										<img
											src="<c:url value="resources"/>/user/image/buy/${product.getImages() }"
											alt="NoImage" class="listCart__item-img"> <span
											class="listCart__item-quantity">${quantity }</span>
									</div>
									<div class="listCart__item-center">
										<p class="listCart__item-name">${product.getProductContent() }</p>
									</div>
									<div class="listCart__item-right">
										<span class="listCart__item-price"> <fmt:formatNumber
												type="currency" currencySymbol="đ"
												value="${product.getProductHasDiscount() }">
											</fmt:formatNumber>
										</span>
									</div>
								</li>
							...
							<div class="listCart__total">
								<div class="total-line-subtotal">
									<span class="total-line-subtotal-left">Tạm Tính : </span> <span
										class="total-line-subtotal-right"> <fmt:formatNumber
											type="currency" currencySymbol="đ" value="${totalMoney }">
										</fmt:formatNumber>
									</span>
								</div>
								<div class="total-line-total">
									<span class="total-line-name">Tổng Cộng : </span> <span
										class="total-line-money"> <fmt:formatNumber
											type="currency" currencySymbol="đ" value="${totalMoney }">
										</fmt:formatNumber>
									</span>
								</div>
